<!--
Author: Vishal Kumar
Author E-Mail: vishalk.engg@gmail.com
-->
<!DOCTYPE html>
<html lang="en">
<head>
<link rel="shortcut icon" href="images/ps_logo.ico" />
<title>Pritam Sengupta</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Pritam Sengupta. A construction company with World class standards and approach!" />
			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<h1><a class="navbar-brand" href="index.html"> Pritam Sengupta</a></h1>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							...
							<li><a href="#clients" class="scroll hvr-bounce-to-bottom">Clients</a></li>
							<li><a href="#projects" class="scroll hvr-bounce-to-bottom">Projects</a></li>
							<li><a href="#testimonials" class="scroll hvr-bounce-to-bottom">Testimonials</a></li>
			...
			<ul class="rslides callbacks callbacks1" id="slider4">
				<li>
					<div class="jarallax agileits-banner-info">
						<div class="caption"><h3>Build your dream project!</h3>
...
<!-- <div class="container"> -->
	...
	<!--	<div class="col-md-6 col-sm-12 col-xs-12 w3l-about-content2">
			<img src="images/New_Logo_2.png" class="img-responsive" height="auto" width="auto" padding="5em">
		</div> -->
		<div class="clearfix"></div>
	</div>
<!-- </div> -->
...
<div class="jarallax agileits-services-main" id="services">
	<div class="container">
	<h3 class="w3-title text-center">services</h3>
...
<div class="agileits-testimonials" id="testimonials">
	<div class="container">
		<h3 class="w3-title text-center">testimonials</h3>
...
<div class="agileits-contact" id="contact">
	<div class="container">
		<h3 class="w3-title text-center">contact</h3>
...
<div class="agileits_w3layouts-map">
	<iframe src="https://www.google.com/maps/embed/v1/place?q=22%C2%B030'04.5%22N%2088%C2%B013'55.3%22E&key=AIzaSyDhj_uE0qT2K7SkiL1zLEXePGnL9Nn6yWc" style="border:0" allowfullscreen></iframe>
</div>
<!--map-->
<!--footer-->
<div class="agileits_w3layouts-footer">
	<div class="col-md-6 col-sm-4 col-xs-5 agileinfo-logo">
		<h6 class="w3-header"><a href="index.html"> Pritam Sengupta</a></h6>
	</div>
	<div class="col-md-6 col-sm-8 col-xs-7 agileinfo-copyright">
		<p>© 2018 Pritam Sengupta. All rights reserved | Developed & Hosted by <a href="mailto:vishalk.engg@gmail.com">Vishal Kumar</a></p>
	</div>
</div>
<!-- //footer -->
